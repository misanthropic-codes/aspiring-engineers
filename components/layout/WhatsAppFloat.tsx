...
export default function WhatsAppFloat() {
  return (
    ...
    >
      ...
      {/* WhatsApp Icon SVG */}
      <svg
        className="relative w-8 h-8 text-white fill-current"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 448 512"
      >
        {/* Font Awesome Free 6.x by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2024 Fonticons, Inc. */}
