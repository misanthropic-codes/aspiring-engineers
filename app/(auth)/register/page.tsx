        ...
        <div className={`p-6 sm:p-8 rounded-2xl border backdrop-blur-2xl shadow-2xl ${
          ...
          <div className="text-center mb-6 sm:mb-8">
            <Link href="/" className="inline-block mb-4">
              <span className="font-clash text-3xl font-bold text-[#2596be]">AE</span>
            </Link>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {[ExamType.JEE_MAIN, ExamType.JEE_ADVANCED, ExamType.NEET, ExamType.WBJEE, ExamType.BITSAT, ExamType.COMEDK].map((exam) => (
                  <button
                    key={exam}
                    type="button"
